...
export type AppSettings = {
  ...
  apiProxyApiKey?: string | null;
  locale: AppLocale;
};

export type AppCapabilities = {
  supportsCloudSync: boolean;
  supportsEditorRestart: boolean;
  supportsTrayUsageDisplay: boolean;
  supportsAutoStart: boolean;
  supportsOpencodeDesktopRestart: boolean;
  cloudSyncReason: string | null;
  editorRestartReason: string | null;
  trayUsageDisplayReason: string | null;
  autoStartReason: string | null;
  opencodeDesktopRestartReason: string | null;
};
