      ...
      <div className="settingsShell">
        ...
        <div className="settingsGroup">
          ...
          <SwitchField
            ...
            onChange={(checked) => onUpdateSettings({ autoSmartSwitch: checked })}
          ...
          {settings.syncOpencodeOpenaiAuth && hasOpencodeDesktopApp ? (
            <SwitchField
              ...
              disabled={savingSettings || !capabilities.supportsOpencodeDesktopRestart}
              rowClassName="settingRowCompact settingRowNested"
            />
          ) : null}

          {!capabilities.supportsOpencodeDesktopRestart && settings.syncOpencodeOpenaiAuth ? (
            <div className="settingRow settingRowCompact settingRowNested">
              <span className="settingValueMuted">
                {capabilities.opencodeDesktopRestartReason ?? "Disabled on this platform."}
              </span>
            </div>
          ) : null}
          ...
          <SwitchField
            ...
            disabled={savingSettings || !capabilities.supportsEditorRestart}
          />

          {!capabilities.supportsEditorRestart ? (
            <div className="settingRow settingRowCompact settingRowNested">
              <span className="settingValueMuted">
                {capabilities.editorRestartReason ?? "Disabled on this platform."}
              </span>
            </div>
          ) : null}
